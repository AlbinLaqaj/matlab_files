...
#define ENCODER_A2 3  // Motor 2 Channel A
#define ENCODER_B2 2  // Motor 2 Channel B

#define MOTOR_RIGHT_FORWARD 7   // Right motor forward (PWM)
#define MOTOR_RIGHT_BACKWARD 6  // Right motor backward (PWM)
#define MOTOR_LEFT_FORWARD 10    // Left motor forward (PWM)
#define MOTOR_LEFT_BACKWARD 9  // Left motor backward (PWM)
...
/********** PID CONSTANTS **********/
#define KP -28   // Proportional gain
...
void motorControl() {
  ...
  if (u > 0) {
    // 'u' is multiplied by 255/9 so that 9 maps to 255.
    pwm = baselinePWM + (int)(fabs(u) * 255.0/9.0);
