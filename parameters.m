...
R = 12.5; % Messung, Ankerwiderstand, [Ra] = Ohm
L = 2.6e-3; % Ankerinduktivität, [La] = H
Km = 0.224; % Schätzung, Motorkonstante, [Km] = V/rad/s 
eta = 0.9; % lower, Schätzung, Getriebewirkungsgrad, [eta] = 1
tau_m = 0.005; % Schätzung, Überbrückungsmoment, [tau_m] = Nm
